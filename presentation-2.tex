...
%		\end{figure}
	...
	\begin{frame}{Предлагаемый состав программы}
		...
		\parbox{\linewidth}{За последнее время появилось большое число новых и эффективных алгоритмов кластеризации. Предлагается разработать программу, в которую входили бы следующие алгоритмы:}
		
       	\begin{itemize}

       		\item \ikmeans \tikz[remember picture] \node[coordinate, xshift=0.5cm,yshift=0.5em] (n1) {};
       		\item \dePDDP
	       	\item \BiKMR \tikz[remember picture] \node[coordinate, xshift=0.5cm,] (n2) {};
      		
      		\item \AWard \tikz[remember picture] \node[coordinate, xshift=0.7cm,yshift=0.5em] (t1) {};
	       	\item \AWardpb   \tikz[remember picture] \node[coordinate, xshift=0.7cm,] (t2) {};
       	\end{itemize}
