...
%		\end{block}
	...
	\begin{frame}{\ikmeans 1}
			\begin{figure} % \ContinuedFloat
				\centering
				\includestandalone[height=0.9\textheight]{img/tikz/ik-means-new/ik-means-1}
			\end{figure}
	\end{frame}
	...
	\begin{frame}{\ikmeans 2}
		\begin{figure} % \ContinuedFloat
			\centering
			\includestandalone[height=0.9\textheight]{img/tikz/ik-means-new/ik-means-2}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{\ikmeans 3}
		\begin{figure} % \ContinuedFloat
			\centering
			\includestandalone[height=0.9\textheight]{img/tikz/ik-means-new/ik-means-3}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{\ikmeans 4}
		\begin{figure} % \ContinuedFloat
			\centering
			\includestandalone[height=0.9\textheight]{img/tikz/ik-means-new/ik-means-4}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{\ikmeans 5}
		\begin{figure} % \ContinuedFloat
			\centering
			\includestandalone[height=0.9\textheight]{img/tikz/ik-means-new/ik-means-5}
		\end{figure}
	\end{frame}
